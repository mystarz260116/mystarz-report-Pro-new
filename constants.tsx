...
// 例: https://script.google.com/macros/s/AKfycb...Xv/exec
...
export const DEPARTMENT_CONFIGS: Record<Department, DeptConfig> = {
  ...
  [Department.COMPLETE_A]: {
    ...
    color: '#8b5cf6',
    sections: [
      { title: 'e.max', items: ['マウント(ケース)', 'トリミング(本)', 'パターン Cr(本)', 'パターン インレー(本)', 'パターン ラミネート(本)', '植立：埋没・プレス(リング)','適合・調整(本)', 'ステイン・完成 Cr(本)', 'ステイン・完成 インレー(本)', 'ステイン・完成 ラミネート(本)'] },
      { title: 'MB', items: ['マウント(ケース)', 'トリミング(本)', 'パターン(フルカントゥア)', 'パターン(キャップ)', '植立・埋没・キャスト(リング)', 'メタル調整(本)', '前ロウ(ヶ所)', '築盛(本)', '形態修正・完成(本)'] },
      { title: 'Zirconia', items: ['マウント(ケース)', 'トリミング(本)', '設計・送り(本)', '適合・調整(本)', 'フルジルコニア ステイン・完成(Cr)', 'フルジルコニア ステイン・完成(インレー)', 'レイヤリング(築盛)(本)', 'レイヤリング(形成修正・完成)(本)'] }
    ],
  },
  [Department.COMPLETE_B]: {
    ...
    sections: [
      ...
      { title: '製作品目', items: ['ハードレジン', 'HJK', 'HB(インレー/ジャケット)', 'HB(金属裏装)', 'ファイバーコア(自費)', 'ファイバーコア(保険)', 'CRインレー', 'クラウン', 'インレー', 'トリミング', 'ホワイトWAX'] },
